...
<head>
    ...
    <style>
        ...
        .role-admin { background: rgba(129, 140, 248, 0.2); color: #818cf8; border: 1px solid rgba(129, 140, 248, 0.3); }
        .role-student { background: rgba(255, 255, 255, 0.05); color: #94a3b8; border: 1px solid rgba(255, 255, 255, 0.1); }
                                        ...
                                        <div style="display:flex; gap:10px;">
                                            <?php if (!$is_me): ?>
                                                <a href="admin_dashboard.php?toggle_role=<?= $row['id'] ?>&view=users" 
                                                   class="action-btn" 
                                                   title="<?= $is_admin_user ? 'Demote to Student' : 'Promote to Admin' ?>"
                                                   style="background: rgba(99, 102, 241, 0.2); color: #818cf8;">
                                                   <span class="material-icons" style="font-size:16px;">
                                                       <?= $is_admin_user ? 'remove_moderator' : 'add_moderator' ?>
                                                   </span>
                                                </a>
                                                ...
                                                <a href="admin_dashboard.php?delete_user=<?= $row['id'] ?>&view=users" 
                                                   ...
                                                   title="Delete User"
                                                   onclick="return confirm('WARNING: This will delete the user AND all their posts. Continue?')">
                                                    <span class="material-icons" style="font-size:16px;">delete</span>
                                                </a>
                                            <?php else: ?>
